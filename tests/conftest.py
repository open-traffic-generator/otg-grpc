...
def snappiserver():
    ...
    from .mocksnappiservers.snappiserver200warning import SnappiServer200Warning # noqa
    ...
    from .mocksnappiservers.snappiserver_not_implemented import SnappiServerNotImplemented # noqa
